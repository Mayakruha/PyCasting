# Installation
```
pip install git+https://github.com/mayakruha/PyCasting.git
```
# Module Usadka_1D
Simple quasi 2D model of a continuous casting billet for calculations of shrinkage, solid shell thickness, stress/temperature distribution. Elastic strain is neglected in the model. Stress, strain etc are calculated on basis of a creep law and the suggestion that cross-sections stay being plane.
